...
function my_theme_enqueue_styles() {
  ...
  wp_localize_script( 'global', 'frontend_ajax_object',
        array( 
...
function next_games() {
   ...
   $events = $wpdb->get_results( "SELECT * FROM wp_em_events WHERE event_end_date >= '$time' AND event_attributes LIKE '$product_id' ORDER BY event_start_date LIMIT 10");
   $output = array();
